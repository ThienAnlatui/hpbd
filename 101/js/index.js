...
var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      S.UI.simulate('|Gì mà| Đến| bây giờ| mới| mở hả|bít tuôi| làm| cái này |lâu khum| dị nên |là  tui |cho gút|5 giây| để |chuẩn bị|sẵn sàng chưa| dzo nè|#countdown 5|HAPPY|BIRTHDAY|to Gúttttt|Chúc Gút|Ngày Càng |Xinh đẹp|Học giỏi|Nhiều tiền|Sinh nhật| zui zẻ heeee|ღ( ´･ᴗ･` )|');
    }
